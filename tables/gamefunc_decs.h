extern void PBM_LobFlamer ( edict_t * self , vec3_t start , vec3_t dir , int speed , float radius , vec3_t damage , vec3_t radius_damage ) ;
extern void PBM_FireFlamer ( edict_t * self , vec3_t start , vec3_t dir , int speed , float radius , vec3_t damage , vec3_t radius_damage , int rain_chance , int blast_chance ) ;
extern void PBM_NapalmTouch ( edict_t * ent , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void PBM_NapalmThink ( edict_t * self ) ;
extern void PBM_FireballTouch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void PBM_FlameCloud ( edict_t * attacker , vec3_t start , vec3_t cloud , vec3_t timer , qboolean deadly , float radius , vec3_t damage , vec3_t radius_damage , int rain_chance , int blast_chance ) ;
extern void PBM_CloudBurstDamage ( edict_t * self ) ;
extern void PBM_CloudBurst ( edict_t * self ) ;
extern void PBM_FireDrop ( edict_t * self ) ;
extern void PBM_FireDropTouch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void PBM_CheckFire ( edict_t * self ) ;
extern void PBM_Ignite ( edict_t * victim , edict_t * attacker ) ;
extern void PBM_Burn ( edict_t * self ) ;
extern qboolean PBM_FlameOut ( edict_t * self ) ;
extern void PBM_FireSpot ( vec3_t spot , edict_t * ent ) ;
extern void PBM_BurnRadius ( edict_t * fire , float radius , vec3_t damage , edict_t * ignore ) ;
extern void PBM_BurnDamage ( edict_t * victim , edict_t * fire , vec3_t damage ) ;
extern qboolean PBM_FireResistant ( edict_t * ent ) ;
extern qboolean PBM_Flammable ( edict_t * ent ) ;
extern qboolean PBM_InWater ( edict_t * ent ) ;
extern void PBM_BecomeNewExplosion ( edict_t * self ) ;
extern void PBM_SmallExplodeThink ( edict_t * self ) ;
extern void PBM_BecomeSteam ( edict_t * self ) ;
extern void PBM_BecomeSmoke ( edict_t * self ) ;
extern void fire_flamerocket ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , float damage_radius , int radius_damage ) ;
extern void firerocket_touch ( edict_t * ent , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void fire_flamegrenade2 ( edict_t * self , vec3_t start , vec3_t aimdir , int damage , int speed , float timer , float damage_radius ) ;
extern void fire_flamegrenade ( edict_t * self , vec3_t start , vec3_t aimdir , int damage , int speed , float timer , float damage_radius ) ;
extern void FireGrenade_Touch ( edict_t * ent , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void FireGrenade_Explode ( edict_t * ent ) ;
extern void SP_Decoy ( edict_t * self ) ;
extern void free_decoy ( edict_t * self ) ;
extern void spawn_decoy ( edict_t * owner ) ;
extern void decoy_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , vec3_t point ) ;
extern void decoy_sight ( edict_t * self , edict_t * other ) ;
extern void decoy_attack ( edict_t * self ) ;
extern void decoy_fire1 ( edict_t * self ) ;
extern void decoy_fire ( edict_t * self , int flash_number ) ;
extern void decoy_pain ( edict_t * self , edict_t * other , float kick , int damage ) ;
extern void decoy_run ( edict_t * self ) ;
extern void decoy_taunt ( edict_t * self ) ;
extern void decoy_stand ( edict_t * self ) ;
extern void decoy_idle ( edict_t * self ) ;
extern void ShowScanner ( edict_t * ent , char * layout ) ;
extern void Toggle_Scanner ( edict_t * ent ) ;
extern void ClearScanner ( gclient_t * client ) ;
...
extern int Q_stricmp ( char const * s1 , char const * s2 ) ;
...
extern void COM_DefaultExtension ( char * path , char const * extension ) ;
extern void COM_FilePath ( char const * in , char * out ) ;
...
extern void Weapon_Freezer ( edict_t * ent ) ;
extern void Weapon_Freezer_Fire ( edict_t * ent ) ;
extern void Freezer_Fire ( edict_t * ent , vec3_t g_offset , int damage , qboolean hyper , int effect ) ;
extern void Weapon_BFG ( edict_t * ent ) ;
extern void weapon_bfg_fire ( edict_t * ent ) ;
extern void Weapon_Railgun2 ( edict_t * ent ) ;
extern void weapon_railgun2_fire ( edict_t * ent ) ;
extern void Weapon_Railgun ( edict_t * ent ) ;
extern void weapon_railgun_fire ( edict_t * ent ) ;
extern void fire_rg ( edict_t * ent , vec3_t g_offset , int damage , qboolean hyper , int effect ) ;
extern void Weapon_Plasma ( edict_t * ent ) ;
extern void Weapon_Plasma_Fire ( edict_t * ent ) ;
extern void Plasma_Fire ( edict_t * ent , vec3_t g_offset , int damage , qboolean hyper , int effect ) ;
extern void Weapon_Sniper ( edict_t * ent ) ;
extern void Weapon_Sniper_Fire ( edict_t * ent ) ;
extern void Sniper_Fire ( edict_t * ent , vec3_t g_offset , int damage , qboolean hyper , int effect ) ;
extern void Weapon_SuperShotgun ( edict_t * ent ) ;
extern void weapon_supershotgun_fire ( edict_t * ent ) ;
extern void Weapon_SawedOffShotgun ( edict_t * ent ) ;
extern void weapon_sawedoffshotgun_fire ( edict_t * ent ) ;
extern void Weapon_Shotgun ( edict_t * ent ) ;
extern void weapon_shotgun_fire ( edict_t * ent ) ;
extern void Weapon_Streetsweeper ( edict_t * ent ) ;
extern void weapon_streetsweeper_fire ( edict_t * ent ) ;
...
extern void Weapon_Machine ( edict_t * ent ) ;
extern void Machine_Fire ( edict_t * ent ) ;
extern void Weapon_HyperBlaster ( edict_t * ent ) ;
extern void Weapon_HyperBlaster_Fire ( edict_t * ent ) ;
extern void Weapon_SuperBlaster ( edict_t * ent ) ;
extern void Weapon_Super_Fire ( edict_t * ent ) ;
extern void Super_Fire ( edict_t * ent , vec3_t g_offset , int damage , qboolean hyper , int effect ) ;
...
extern void Weapon_GuidedRocketLauncher ( edict_t * ent ) ;
extern void Weapon_GuidedRocket_Fire ( edict_t * ent ) ;
extern void Weapon_RocketLauncher ( edict_t * ent ) ;
extern void Weapon_RocketLauncher_Fire ( edict_t * ent ) ;
extern void Weapon_Bazooka ( edict_t * ent ) ;
extern void weapon_bazooka_fire ( edict_t * ent ) ;
extern void Weapon_GrenadeLauncher ( edict_t * ent ) ;
extern void weapon_grenadelauncher_fire ( edict_t * ent ) ;
extern void Use_GrenadeWeapon ( edict_t * ent , gitem_t * item ) ;
...
extern void ThirdEnd ( edict_t * ent ) ;
extern void ThirdBegin ( edict_t * ent ) ;
...
extern void Cmd_Hook_f ( edict_t * ent ) ;
extern void FireHook ( edict_t * ent ) ;
extern void HookAirborne ( edict_t * ent ) ;
extern void HookTouch ( edict_t * ent , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void HookBehavior ( edict_t * ent ) ;
extern void MaintainLinks ( edict_t * ent ) ;
extern void DropHook ( edict_t * ent ) ;
extern void P_ProjectSource_Reverse ( gclient_t * client , vec3_t point , vec3_t distance , vec3_t forward , vec3_t right , vec3_t result ) ;
extern void ClientBeginServerFrame ( edict_t * ent ) ;
extern void ClientThink ( edict_t * ent , usercmd_t * ucmd ) ;
extern qboolean IdleCheck ( edict_t * ent , usercmd_t * ucmd ) ;
...
extern void LogPlayerMovement ( edict_t * ent , int botCode ) ;
extern int BotCheck ( edict_t * ent , usercmd_t * ucmd ) ;
extern bot_record_t GetBotRecord ( edict_t * ent , usercmd_t * ucmd ) ;
extern void ReadLevel ( char const * filename ) ;
extern void WriteLevel ( char const * filename ) ;
extern void ReadGame ( char const * filename ) ;
extern void WriteGame ( char const * filename , qboolean autosave ) ;
...
extern void LaserSightThink ( edict_t * self ) ;
extern void LaserSight_On ( edict_t * self ) ;
extern void LaserSight_Off ( edict_t * self ) ;
extern void LaserSight_Check ( edict_t * self ) ;
extern void SP_LaserSight ( edict_t * self ) ;
extern void PlaceLaserTripwire ( edict_t * ent ) ;
extern void pre_weapon_lasertrip_think ( edict_t * self ) ;
extern void weapon_lasertrip_think ( edict_t * self ) ;
extern void weapon_lasertrip_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , vec3_t point ) ;
extern void Kamikaze_Explode ( edict_t * self ) ;
extern void Kamikaze_Cancel ( edict_t * self ) ;
extern qboolean Kamikaze_Active ( edict_t * self ) ;
extern void Start_Kamikaze_Mode ( edict_t * self ) ;
extern void Jet_ApplyJet ( edict_t * ent , usercmd_t * ucmd ) ;
extern void Jet_ApplyRolling ( edict_t * ent , vec3_t right ) ;
...
extern qboolean Jet_Active ( edict_t * ent ) ;
extern qboolean Jet_AvoidGround ( edict_t * ent ) ;
extern void fire_freezer ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , int effect ) ;
extern void freezer_touch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void fire_guidedrocket ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , float damage_radius , int radius_damage ) ;
extern void guidedrocket_touch ( edict_t * ent , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void guidedrocket_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , vec3_t point ) ;
extern void guidedrocket_explode ( edict_t * ent ) ;
extern void guidedrocket_think ( edict_t * ent ) ;
extern void fire_rail ( edict_t * self , vec3_t start , vec3_t aimdir , int damage , int kick ) ;
extern void fire_super ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , int effect ) ;
extern void super_touch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
...
extern void fire_mr ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , float damage_radius , int radius_damage ) ;
extern void mr_touch ( edict_t * ent , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void fire_rocket ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , float damage_radius , int radius_damage ) ;
extern void fire_grenade_dM ( edict_t * self , vec3_t start , vec3_t aimdir , int damage , int speed , float timer , float damage_radius , int typ , qboolean held , qboolean bazookad ) ;
extern void bazooka_think ( edict_t * self ) ;
extern void fire_grenade ( edict_t * self , vec3_t start , vec3_t aimdir , int damage , int speed , float timer , float damage_radius ) ;
extern void Grenade_Explode_dM ( edict_t * ent ) ;
extern void Shrap_Explode_Touch ( edict_t * ent , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void Shrap_Explode ( edict_t * ent ) ;
extern void Cata_Explode_Touch ( edict_t * ent , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void Cata_Explode ( edict_t * ent ) ;
extern void Flame_Burn ( edict_t * ent ) ;
extern void Flame_Touch ( edict_t * ent , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void plasma_explode ( edict_t * ent ) ;
extern void fire_bolt ( edict_t * self , vec3_t start , vec3_t aimdir , int damage ) ;
...
extern void fire_sniper ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , int effect ) ;
extern void sniper_touch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void fire_blaster ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , int effect ) ;
...
extern void TeamplayRebalanceTeams ( void ) ;
extern void TeamplayStartRound2 ( void ) ;
extern qboolean TeamplayCheckRound2 ( void ) ;
extern qboolean TeamplayCheckRound1 ( void ) ;
extern void TeamplayDoCountdown ( void ) ;
extern qboolean TeamplayCheckCountdown ( void ) ;
extern void TeamplayCheckRespawn ( void ) ;
extern void TeamplaySpawnpointTouch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void TeamplaySetupSpawnpoint ( edict_t * spot ) ;
extern void SP_info_teleport_destination ( edict_t * ent ) ;
extern void SP_trigger_teleport ( edict_t * ent ) ;
extern char * CTFCheckRules ( void ) ;
extern qboolean CTFStartClient ( edict_t * ent ) ;
extern void TeamplayMakeObserver ( edict_t * ent ) ;
extern void CTFCredits ( edict_t * ent , pmenu_t * p ) ;
...
extern void CTFReturnToMain ( edict_t * ent , pmenu_t * p ) ;
extern void CTFChaseCam ( edict_t * ent , pmenu_t * p ) ;
extern void CTFJoinTeam2 ( edict_t * ent , pmenu_t * p ) ;
extern void CTFJoinTeam1 ( edict_t * ent , pmenu_t * p ) ;
...
extern void CTFScoreboardMessage ( edict_t * ent , edict_t * killer , char string [ 1400 ] ) ;
extern void CTFTeam_f ( edict_t * ent ) ;
extern void CTFSetTeam ( edict_t * ent , int desired_team ) ;
...
extern void CTFID ( edict_t * ent , pmenu_t * p ) ;
extern void CTFID_f ( edict_t * ent ) ;
extern void CTFCalcScores ( void ) ;
extern edict_t * SelectCTFSpawnPoint ( edict_t * ent , qboolean * spawnlive ) ;
...
extern void SVCmd_LogPlayer_f ( void ) ;
extern void SVCmd_PlaySound_f ( void ) ;
extern void SVCmd_Team_f ( void ) ;
extern void SVCmd_KickBan_f ( void ) ;
extern void Svcmd_Survey_f ( void ) ;
...
extern void CustomSpawnEntities ( char * mapname , char * entities , char * spawnpoint ) ;
...
extern void misc_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , vec3_t point ) ;
...
extern void HACK_SpawnEntities ( char * mapname , char * entities , char * spawnpoint ) ;
extern int HACK_modelindex ( char * name ) ;
...
extern int __cdecl CompareItemsByPickup ( const void * a , const void * b ) ;
...
extern int GetIndexByItem ( gitem_t * item ) ;
...
extern void touch_killbox ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
...
extern void Cmd_Zoom_f ( edict_t * ent ) ;
extern void Cmd_Lowlight_f ( edict_t * ent ) ;
extern void Cmd_Say_f ( edict_t * ent , qboolean team , qboolean arg0 ) ;
extern void Cmd_FireMode_f ( edict_t * ent ) ;
extern void Cmd_Wave_f ( edict_t * ent ) ;
extern void Cmd_Pull_f ( edict_t * ent ) ;
extern void Cmd_Push_f ( edict_t * ent ) ;
...
extern void Cmd_LastWeap_f ( edict_t * ent ) ;
...
extern void Cmd_ThirdZ_f ( edict_t * ent ) ;
extern void Cmd_ThirdX_f ( edict_t * ent ) ;
extern void Cmd_Third_f ( edict_t * ent ) ;
extern void Cmd_Kamikaze_f ( edict_t * ent ) ;
...
extern void ThrowShrapnel4 ( edict_t * self , char * modelname , float speed , vec3_t origin ) ;
extern void ThrowShrapnel3 ( edict_t * self , char * modelname , float speed , vec3_t origin ) ;
extern void ThrowShrapnel2 ( edict_t * self , char * modelname , float speed , vec3_t origin ) ;
extern void ThrowShrapnel ( edict_t * self , char * modelname , float speed , vec3_t origin ) ;
extern void BigBang ( edict_t * ent ) ;
extern qboolean isvisible ( edict_t * self , edict_t * other ) ;
extern void BecomeNewExplosion ( edict_t * ent ) ;
extern void T_ShockItems ( edict_t * inflictor ) ;
extern void T_ShockWave ( edict_t * inflictor , float damage , float radius ) ;
extern void make_debris ( edict_t * ent ) ;
